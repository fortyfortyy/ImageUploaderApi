...
class Image(models.Model):
    ...
    image = models.ImageField(upload_to=image_upload_path, validators=[validate_image_extension], storage=CustomImageStorage())
    ...
    def get_thumbnails(self):
        ...
        base_file = os.path.dirname(self.image.url)
...
class ExpiringLink(models.Model):
    ...
    def __repr__(self):
        return """ExpiringLink(image='%s', link='%s', expiry_time='%s')""" % (self.image, self.link, self.expiry_time)
